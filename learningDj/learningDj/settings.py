"""
Django settings for learningDj project.
...
SECRET_KEY = 'django-insecure-nr)7@*fqa(@_$flo37$ih#+#4@=+#r5m%anapcz6kixdd8j2l7'
...
WSGI_APPLICATION = 'learningDj.wsgi.application'
